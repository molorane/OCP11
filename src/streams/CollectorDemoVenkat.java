...
public class CollectorDemoVenkat {
	...
	public static void toMap() {
		...
		Map<Boolean, Map<String, Map<Integer, Map<Gender,Person>>>> list =
		people
		.stream()
		.collect(
	...
	public static void maxByAndTransoform() {
		...
		System.out.println(
					...
					// .collect(Collectors.maxBy(Comparator.comparingInt(Person::getAge)))); //ToIntFunction
					// .collect(Collectors.maxBy(Comparator.comparingLong(Person::getAge)))); ToLongFunction
					// .collect(Collectors.maxBy(Comparator.comparingDouble(Person::getAge)))); ToDoubleFunction
	}

	/*
	 * Use cases (maxBy, minBy) work same way
	 * 
	 * 1. Person who is oldest
	 * 2. Person with highest salary
	 * 3. Person who worked longest in a particular department
	 * 4. 
	 */
	...
	public static void accumulateStrings() {
		List<String> list = strings.stream().collect(ArrayList::new, ArrayList::add,
			                                               ArrayList::addAll);
	...
	public static void groupingBy3() {
		...
		Map<String, Map<Integer, Map<Gender, List<Person>>>> list =
					people
					.stream()
					.filter(p -> p.getAge() > 30)
					.collect(Collectors.groupingBy(Person::getName,
